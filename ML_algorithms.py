...
def keras_deep(input_dim=39, n_layers=9, n_neurons=12, r_dropout=0.15, optimizer="rmsprop", loss="binary_crossentropy", init="uniform", metrics=utils.f1):
    """
...
def keras_lstm(train_X=None, optimizer="rmsprop",
               loss="binary_crossentropy", metrics = utils.f1):
    # define model
